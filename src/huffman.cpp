...
static const std::string dcChrominanceCodes[12] = {
        "00",
        "01",
        "10",
        "110",
...
static const std::string dcLuminanceCodes[12] = {
        "00",
        "010",
        "011",
        "100",
...
std::map<std::pair<int, int>, std::string> acLuminanceCodes = {
    {{0, 0}, "1010"},          // EOB
    {{0, 1}, "00"},
    {{0, 2}, "01"},
    {{0, 3}, "100"},
...
std::map<std::pair<int, int>, std::string> acChrominanceCodes = {
        {{0, 0}, "00"},          // EOB
        {{0, 1}, "01"},
        {{0, 2}, "100"},
        {{0, 3}, "1010"},
